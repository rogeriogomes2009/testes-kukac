...
const Ceps = () => {
  ...
  const handleSubmmit = async ({ cep_1, cep_2, cep_3, cep_4, cep_5 }) => {
  ...
  return (
    <>
      <div className="container background-container mt-5" >
        ...
        <div>
          <Formik onSubmit={handleSubmmit} initialValues={{ cep_1: '', cep_2: '', cep_3: '', cep_4: '', cep_5: '' }}>
          ...
          <div className='container'>
            <div className="box-numbers p-3">
              <div data-js='ceps' className="numbers container d-flex flex-wrap gap-3 justify-content-center align-items-center col-12 my-4">
                {!!ListCeps && ListCeps?.map(({ uf, logradouro, bairro, localidade }, idx) => {
                  return (
                    <Cep
                      key={idx}
                      uf={uf}
